...
import proyecto_1.presentation.historico.TableModel;
import proyecto_1.presentation.historico.buscarPaciente.View_BuscarPaciente;
import proyecto_1.presentation.historico.verReceta.View_VerReceta;
...
public class View_Historico implements PropertyChangeListener {
    Controller_Historico controller;
    ...
    private View_VerReceta editarEstado;
    private String filtroBusqueda;

    public View_Historico() {
        buscarPaciente = new View_BuscarPaciente();
        editarEstado = new View_VerReceta();
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        switch (evt.getPropertyName()) {
            case Model_Historico.RECETAS:
                ...
                break;
            case Model_Historico.CURRENT_PACIENTE:
                ...
                break;
            case Model_Historico.CURRENT_ESTADO:
