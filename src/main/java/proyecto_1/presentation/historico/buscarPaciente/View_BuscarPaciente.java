...
import proyecto_1.presentation.historico.buscarPaciente.TableModel;
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        switch (evt.getPropertyName()) {
            case Model_Historico.PACIENTES:
                int[] cols = {proyecto_1.presentation.despacho.buscarPaciente.TableModel.ID, proyecto_1.presentation.despacho.buscarPaciente.TableModel.NOMBRE, proyecto_1.presentation.despacho.buscarPaciente.TableModel.TELEFONO, proyecto_1.presentation.despacho.buscarPaciente.TableModel.FECHANACIMIENTO};
