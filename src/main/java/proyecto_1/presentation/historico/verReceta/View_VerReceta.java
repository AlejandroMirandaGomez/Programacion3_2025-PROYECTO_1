    ...
    public void propertyChange(PropertyChangeEvent evt) {
        switch (evt.getPropertyName()) {
            case Model_Historico.CURRENT_RECETA:
                ...
                int[] cols = {proyecto_1.presentation.despacho.editarEstado.TableModel.MEDICAMENTO, proyecto_1.presentation.despacho.editarEstado.TableModel.PRESENTACION, proyecto_1.presentation.despacho.editarEstado.TableModel.INDICACION, proyecto_1.presentation.despacho.editarEstado.TableModel.CANTIDAD, proyecto_1.presentation.despacho.editarEstado.TableModel.DURACION};
